                                         ...
                                         <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                                              ...
                                              <div class="modal-content">
                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data">
                                                  <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                      <label for="title">Feedback Reply</label>
                                            ...
                                            <div class="container my-5 acceptme">
                                              ...
                                              <table class="table" id="myTable">
                                                ...
                                                <tbody>
                                                  <?php 
                                                    $sql = "SELECT user_ecom.u_id, user_ecom.u_name , feedback_ecom.f_desc , feedback_ecom.f_date , product_ecom.p_name FROM user_ecom INNER JOIN feedback_ecom ON
                                                    user_ecom.u_id = feedback_ecom.u_id JOIN product_ecom ON feedback_ecom.p_id = product_ecom.p_id;";
                                                    $result = mysqli_query($conn, $sql);
                                                    while($row = mysqli_fetch_assoc($result)){
                                                      ...
                                                      <td> <i class='edit fa fa-reply' id="<?php echo $row['u_id'];?>"></i></td>
                                                    </tr>
                                                    <?php
                                                  } 
                                                    ?>
