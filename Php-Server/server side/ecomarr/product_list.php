...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `product_ecom` WHERE `p_id` = $sno";
  $result = mysqli_query($conn, $sql);

  if($result)
  {
    header('location:product_list.php?record_delete_true=yes');
  }
  else
  {
    header('location:product_list.php?record_delete_false=no');
...
if (isset( $_POST['snoEdit'])){
  // Update the record
    ...
    if($image['name'] == "" )
    {
            ...
            $sql="update product_ecom set p_name='$name', p_code='$code', p_date='$pdate', p_stock='$stock', p_price='$price', p_desc='$description' where p_id='$id'"; 
            $result=$conn->query($sql);
             if($result){
                $update = true;
                header('location:product_list.php?record_update_true=yes');
              }
              else{
                header('location:product_list.php?record_update_false=no');
                  }
    }
    else
    {
      ...
      if($fileerror==0){
       ...
       // Sql query to be executed
         $sql = "update product_ecom set p_name='$name', p_code='$code', p_date='$pdate', p_image='$destfile',p_stock='$stock', p_price='$price', p_desc='$description' where p_id='$id'";
          $result=$conn->query($sql);
          if($result){
            $update = true;
            header('location:product_list.php?record_update_true=yes');
                                         ...
                                         <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data">
                                                  <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input type="hidden" class="form-control" id="idEdit" name="id" aria-describedby="emailHelp">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                      <label for="desc"> product stock</label>
                                                    ...
                                                    <!-- <div class="form-group">
                                                      <label for="desc" hidden> Image</label>
                                            ...
                                            <div class="container my-5 acceptme">
                                              ...
                                              <table id="myTable" class="display nowrap" style="width:100%">
                                                ...
                                                <tbody>
                                                  <?php 
                                                    $sql = "SELECT * FROM category_ecom join sub_category_ecom ON category_ecom.c_id = sub_category_ecom.c_id JOIN product_ecom ON sub_category_ecom.s_c_id = product_ecom.s_c_id";
                                                    $result = mysqli_query($conn, $sql);
                                                    while($row = mysqli_fetch_assoc($result)){
                                                      ...
                                                      <td> 
                                                       <i class='edit fa fa-edit' id="<?php echo $row['p_id'];?>"></i>&nbsp; &nbsp; &nbsp; &nbsp;
                                                       <i class='delete fa fa-trash' id="d<?php echo $row['p_id'];?>"></i>  
                                            ...
                                            <script>
                                              edits = document.getElementsByClassName('edit');
                                                  ...
                                                  element.addEventListener("click", (e) => {
                                                    ...
                                                    code = tr.getElementsByTagName("td")[4].innerText;
                                                    stock = tr.getElementsByTagName("td")[5].innerText;
                                                    price = tr.getElementsByTagName("td")[6].innerText;
                                                    description = tr.getElementsByTagName("td")[7].innerText;
                                                    pdate = tr.getElementsByTagName("td")[8].innerText;
                                                    // pimage = tr.getElementsByTagName("td")[8].innerText;
                                                    ...
                                                    dateEdit.value=pdate;
                                                    // imageEdit.value=pimage;
                                              ...
                                              Array.from(deletes).forEach((element) => {
                                                element.addEventListener("click", (e) => {
                                                  ...
                                                  if (confirm("Are you sure you want to delete this record!")) {
                                                    console.log("yes");
                                                    window.location = `/ecomarr/product_list.php?delete=${sno}`;
