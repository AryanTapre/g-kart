<div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-product-hunt" aria-hidden="true"></i><span>Product</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
				  
					<li><a href="category_add.php">Add category</a></li>		
					<li><a href="subcategory_add.php">Add sub category</a></li>	 
					<li><a href="product_add.php">Add product</a></li>	            
		          </ul>
		        </li>


				<li><a href="feedback.php"><i class="fa fa-thumbs-up"></i><span>Feedback</span><span  style="float: right"></span></a> 
		        </li>
